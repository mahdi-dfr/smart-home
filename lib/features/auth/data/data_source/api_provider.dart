...
class AuthApiProvider {
  ...
  Future<dynamic> registerUser(Map<String, dynamic> registerBody) async {
    ...
    var response = await _dio.post(UrlConstant.baseUrl + UrlConstant.register,
      data: registerBody,
  ...
  //       options: Options(responseType: ResponseType.json, method: 'POST'), data: {'username':username, 'password':password});
  //   print(response);
  //
  //   return response;
  // }
