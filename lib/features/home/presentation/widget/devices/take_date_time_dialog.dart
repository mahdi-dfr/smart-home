  ...
  return Get.defaultDialog(
      ...
      content: Container(
        ...
        decoration: BoxDecoration(
            ...
            border:
                Border.all(color: CustomColors.foregroundColor, width: 0.5)),
            ...
            children: [
              ...
              CustomButton(onClick: () {
                if (isOn) {
                  ...
                  Get.find<DeviceHelperController>().daysOnList.value =
                      daysList;
                  Get.back();
                } else {
                  Get.find<DeviceHelperController>().hourOff = hour;
                  Get.find<DeviceHelperController>().minuteOff = minute;
                  Get.find<DeviceHelperController>().daysOffList.value =
                      daysList;
                  Get.back();
                }
              }),
