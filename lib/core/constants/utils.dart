...
class AppUtils {
  ...
  static Map<String, String> deviceInfo = {
    'کلید سه تایمر':
        'این دسته شامل وسایلی است که تنها دو حالت میگیرند و میتوان سه زمان روشن شدن برای آن ها در نظر گرفت.',
    'کلید تک تایمر':
        'این دسته شامل وسایلی است که تنها دو حالت میگیرند و میتوان یک زمان روشن شدن برای آن ها در نظر گرفت.',
    ...
    'چشمی ها و سنسور تشخیص حرکت':
        'این دسته شامل چشمی ها و سنسور حرکت است که شما میتوانید در صورت نیاز آن هارا خاموش یا روشن نمایید',
    'دیمر ها':
        'این دسته شامل دیمر هاست که در آن تمام دیمر ها نشان داده شده است و شما میتوانید آنهارا خاموش یا رونش نموده و یا میزان آن را تنظیم نمایید.',
  };
